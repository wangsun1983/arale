...
{
    kprintf("test_sleep_1_fun start \n");
    ksleep(200000);
    kprintf("test_sleep_1_fun end \n");
}

void test_sleep_2_fun(void *args)
{
    kprintf("test_sleep_2_fun start \n");
    ksleep(100000);
    kprintf("test_sleep_2_fun end \n");
}

void test_sleep_3_fun(void *args)
{
    kprintf("test_sleep_3_fun start \n");
    ksleep(300000);
    kprintf("test_sleep_3_fun end \n");
}
